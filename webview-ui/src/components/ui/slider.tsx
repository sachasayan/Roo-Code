...
>(({ className, ...props }, ref) => (
	<SliderPrimitive.Root
		...
		{...props}>
		<SliderPrimitive.Track className="relative w-full h-[8px] grow overflow-hidden bg-accent border border-vscode-slider-border-light dark:border-vscode-slider-border-dark rounded-sm">
